...
class StartScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.atlas('MonsterOne', 'assets/sprites/MonsterOne.png', 'assets/sprites/MonsterOne.json');
		this.load.atlas('MonsterTwo', 'assets/sprites/MonsterTwo.png', 'assets/sprites/MonsterTwo.json')
		this.load.atlas('MonsterTwo_Death', 'assets/sprites/MonsterTwoDeath.png', 'assets/sprites/MonsterTwoDeath.json')
		this.load.atlas('MonsterOne_Death', 'assets/sprites/MonsterOneDeath.png', 'assets/sprites/MonsterOneDeath.json')
