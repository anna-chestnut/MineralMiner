class Player extends Phaser.GameObjects.Sprite{
    ...
    constructor(scene, x, y, speed){
      ...
      super(scene, x, y, 'AstroShovel', 'Astro-right-6.png');
      ...
      scene.anims.create({
        key: 'Astro-right',
        frames: scene.anims.generateFrameNames('AstroShovel', { start: 1, end: 10, prefix: 'Astro-right-', suffix: '.png'}),
        frameRate: 8,
        repeat: -1
    })
    ...
    scene.anims.create({
        key: 'Astro-left',
        frames: scene.anims.generateFrameNames('AstroShovel', { start: 1, end: 10, prefix: 'Astro-left-', suffix: '.png'}),
        frameRate: 8,
        repeat: -1
    })
    ...
    scene.anims.create({
        key: 'Astro-down',
        frames: scene.anims.generateFrameNames('AstroShovel', { start: 1, end: 10, prefix: 'Astro-down-', suffix: '.png'}),
        frameRate: 8,
        repeat: -1
    })
    ...
    scene.anims.create({
        key: 'Astro-idle',
        frames: scene.anims.generateFrameNames('AstroShovel', { start: 5, end: 5, prefix: 'Astro-down-', suffix: '.png'}),
        frameRate: 8,
        repeat: -1
    })
