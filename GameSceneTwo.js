...
class GameSceneTwo extends Phaser.Scene {
	...
	create() {
		...
		gameSettings.playerX= 5;
		gameSettings.playerY= 6;
		gameSettings.isMoving= false;
		gameSettings.scene = 'maingametwo';
...
*/
		...
		var r1 = new Rock(this, 11,0, 'GreenRock');
		var r2 = new Rock(this, 9,8, 'PurpleRock');
		var r3 = new Rock(this, 3,1, 'PinkRock');
		var r4 = new Rock(this, 2,8, 'GreenRock');
		var r5 = new Rock(this, 1,3, 'BlueRock');

		this.initialDug();

		this.monsters = this.physics.add.group();
		this.m1 = new Monster(this, 2,2,0.8);
		this.m2 = new MonsterTwo(this, 1,7,0.8);
		this.m3 = new Monster(this, 8,8,0.8);
...
*/
		this.fillingDug(0,0,true,true,true,true,true);
		this.fillingDug(0,1,true,true,true,true,false);
		this.fillingDug(0,1,true,true,true,true,false);
		this.fillingDug(1,1,true,true,true,true,true);
		this.fillingDug(2,0,true,true,true,true,true);
		this.fillingDug(2,1,true,true,true,true,true);
		this.fillingDug(1,0,true,true,true,true,true);
		

		this.fillingDug(7,2,true,true,true,true,true);
		this.fillingDug(8,3,true,true,true,true,true);

		this.fillingDug(0,7,true,true,true,true,false);
		this.fillingDug(1,7,true,true,true,true,false);
		this.fillingDug(2,7,true,true,true,true,false);
		this.fillingDug(2,8,true,true,true,true,true);

		this.fillingDug(9,7,true,true,true,true,false);
		this.fillingDug(8,7,true,true,true,true,false);
		this.fillingDug(8,8,true,true,true,true,false);
		this.fillingDug(9,8,true,true,true,true,false);
	...
	UpdateRock(){
		...
		for (var i = 0; i < this.rocks.getChildren().length; i++) {
			...
			//for (var i = 0; i < this.monsters.getChildren().length; i++) {
				...
				if(!this.m3.getDie() && Phaser.Geom.Rectangle.Overlaps(this.player.getBounds(), this.m3.getBounds())){
					this.gameOver();
				}
				this.m3.update();
